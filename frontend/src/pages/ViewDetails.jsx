...
export default function ViewDetails({ open, onClose, claimInfo }) {
    ...
    return (
        <div className={`fixed inset-0 z-50 flex justify-center items-center transition-colors duration-200 ${open ? "visible bg-black/50" : "invisible"}`}>
            <div onClick={(e) => e.stopPropagation()} className={`relative bg-white rounded-xl shadow p-6 w-6xl h-11/12 transition-all duration-200 dark:bg-slate-950 dark:border dark:border-gray-600 ${open ? "scale-100 opacity-100" : "scale-125 opacity-0"}`} >
                {/* Close Button */}
                        ...
                        {activeTab === "Summary" && (
                            <div className="grid grid-cols-2 grid-rows-[1fr_auto] gap-6 h-full">
                                ...
                                <div className="border rounded-xl border-gray-500/30 p-4 overflow-y-auto">
                                    ...
                                    <div className="grid grid-cols-2 mt-5 gap-4">
                                        ...
                                        <div className="flex flex-col justify-center items-start text-sm font-medium">
                                            ...
                                            <p className="dark:text-white">{claimInfo.dateOfLoss?.split("T")[0]}</p>
                                        </div>
                                        <div className="flex flex-col justify-center items-start text-sm font-medium">
                                            <p className="text-zinc-500 dark:text-slate-400">Date Received:</p>
                                            <p className="dark:text-white">{claimInfo.dateReceived?.split("T")[0]}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="border rounded-xl border-gray-500/30 p-4 overflow-y-auto">
                                    ...
                                    <div className="grid grid-cols-1 mt-5 gap-4">
                                        ...
                                        <div className="flex flex-col justify-center items-start text-sm">
                                            ...
                                            <p className="dark:text-white">{claimInfo.insured.address}</p>
                                        </div>
                                        <div className="flex flex-row justify-start items-center text-sm gap-2">
                                            ...
                                            <p className="dark:text-white">{claimInfo.insured.phone}</p>
                                        </div>
                                        <div className="flex flex-row justify-start items-center text-sm gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 text-zinc-500 dark:text-slate-400">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                                            </svg>
                                            <p className="dark:text-white">{claimInfo.insured.email}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="border rounded-xl border-gray-500/30 p-4 col-span-2 h-36 overflow-y-auto">
                                    ...
                                    <p className="dark:text-white mt-3 text-sm">{claimInfo.description}</p>
                                </div>
                            </div>
                        )}
                        {activeTab === "Parties" && (
                            <div className="grid grid-cols-2 grid-rows-[1fr_auto] gap-6 h-full">
                                ...
                                <div className="border rounded-xl border-gray-500/30 p-4 overflow-y-auto">
                                    ...
                                    <div className="grid grid-cols-1 mt-5 gap-4">
                                        <div className="flex flex-col justify-center items-start text-sm font-medium">
                                            <p className="text-zinc-500 dark:text-slate-400">Name:</p>
                                            <p className="dark:text-white">{claimInfo.broker.name}</p>
                                        </div>
                                        <div className="flex flex-col justify-center items-start text-sm">
                                            <p className="text-zinc-500 dark:text-slate-400 font-medium">Address:</p>
                                            <p className="dark:text-white">{claimInfo.broker.address}</p>
                                        </div>
                                        <div className="flex flex-row justify-start items-center text-sm gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 text-zinc-500 dark:text-slate-400">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
                                            </svg>
                                            <p className="dark:text-white">{claimInfo.broker.phone}</p>
                                        </div>
                                        <div className="flex flex-row justify-start items-center text-sm gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 text-zinc-500 dark:text-slate-400">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                                            </svg>
                                            <p className="dark:text-white">{claimInfo.broker.email}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="border rounded-xl border-gray-500/30 p-4 overflow-y-auto">
                                    ...
                                    <div className="grid grid-cols-1 mt-5 gap-4">
                                        <div className="flex flex-col justify-center items-start text-sm font-medium">
                                            <p className="text-zinc-500 dark:text-slate-400">Name:</p>
                                            <p className="dark:text-white">{claimInfo.insurer.name}</p>
                                        </div>
                                        <div className="flex flex-col justify-center items-start text-sm">
                                            <p className="text-zinc-500 dark:text-slate-400 font-medium">Address:</p>
                                            <p className="dark:text-white">{claimInfo.insurer.address}</p>
                                        </div>
                                        <div className="flex flex-row justify-start items-center text-sm gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 text-zinc-500 dark:text-slate-400">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
                                            </svg>
                                            <p className="dark:text-white">{claimInfo.insurer.phone}</p>
                                        </div>
                                        <div className="flex flex-row justify-start items-center text-sm gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 text-zinc-500 dark:text-slate-400">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                                            </svg>
                                            <p className="dark:text-white">{claimInfo.insurer.email}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="border rounded-xl border-gray-500/30 p-4 col-span-2 h-36 overflow-y-auto">
                                    ...
                                    <div className="grid grid-cols-4 mt-5">
                                        <div className="flex flex-col justify-center items-start text-sm font-medium">
                                            ...
                                            <p className="dark:text-white">{claimInfo.policyType}</p>
                                        </div>
                                        <div className="flex flex-col justify-center items-start text-sm font-medium">
                                            <p className="text-zinc-500 dark:text-slate-400">Policy No:</p>
                                            <p className="dark:text-white">{claimInfo.policyNo}</p>
                                        </div>
                                        <div className="flex flex-col justify-center items-start text-sm font-medium">
                                            <p className="text-zinc-500 dark:text-slate-400">Inception Date:</p>
                                            <p className="dark:text-white">{claimInfo.inceptionDate?.split("T")[0]}</p>
                                        </div>
                                        <div className="flex flex-col justify-center items-start text-sm font-medium">
                                            <p className="text-zinc-500 dark:text-slate-400">Due Date:</p>
                                            <p className="dark:text-white">{claimInfo.dueDate?.split("T")[0]}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        )}
                        {activeTab === "Timeline" && <p>🗓️ Timeline of the claim.</p>}
                        {activeTab === "Invoicing" && <p>💰 Invoicing details shown here.</p>}
                        {activeTab === "TimeStamps" && (
                            <p>⏱️ Timestamps and logs will appear here.</p>
                        )}
                    </div>
                </div>
            </div>
